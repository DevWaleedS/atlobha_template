...
export function getProductsList(options = {}, filterValues = {}) {
    const filters = [
        new CategoryFilterBuilder('category', 'التصنيفات'),
        new RangeFilterBuilder('price', 'السعر'),
        new CheckFilterBuilder('brand', 'العلامة التجارية'),
        new RadioFilterBuilder('discount', 'الخصومات'),
        new ColorFilterBuilder('color', 'اللون'),
    ];
